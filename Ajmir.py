...
def banner():
    ...
    print(f"""   
\033[33;1m/$$$$$$$  /$$   /$$         /$$$$$$     /$$$$$ /$$      /$$ /$$$$$$ /$$$$$$$ 
\033[33;1m| $$__  $$| $$  / $$        /$$__  $$   |__  $$| $$$    /$$$|_  $$_/| $$__  $$
\033[33;1m| $$  \ $$|  $$/ $$/       | $$  \ $$      | $$| $$$$  /$$$$  | $$  | $$  \ $$
\033[33;1m| $$  | $$ \  $$$$/ /$$$$$$| $$$$$$$$      | $$| $$ $$/$$ $$  | $$  | $$$$$$$/
\033[33;1m| $$  | $$  >$$  $$|______/| $$__  $$ /$$  | $$| $$  $$$| $$  | $$  | $$__  $$
\033[33;1m| $$  | $$ /$$/\  $$       | $$  | $$| $$  | $$| $$\  $ | $$  | $$  | $$  \ $$
\033[33;1m| $$$$$$$/| $$  \ $$       | $$  | $$|  $$$$$$/| $$ \/  | $$ /$$$$$$| $$  | $$
\033[33;1m|_______/ |__/  |__/       |__/  |__/ \______/ |__/     |__/|______/|__/  |__/                                              
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} DX-AJMIR                 {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}DX Ajmir Hossain      {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801813225678    {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/DX-142{N}    {H}  ║
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract DX AJMIR ')
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/DX-142");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/Ajmir.Hossain.008?mibextid=ZbWKwL'');mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}DX-AJMIR{P}Terminal ');os.system("xdg-open https://www.facebook.com/Ajmir.Hossain.008?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://facebook.com/groups/517746880494588/');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/Ajmir.Hossain.008");mainx()
def mainx2():
    os.system("clear")
    banner()
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30mAJMIR-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             ...
             break
                ...
                ok+=1
                print(f'\r{P} [{H}AJMIR-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
...
def m2(idf,pwv):
 global loop,ok,cp
 animasi = random.choice(["\x1b[1;91mAJMIR","\x1b[1;92mAJMIR","\x1b[1;93mAJMIR","\x1b[1;94mAJMIR","\x1b[1;95mAJMIR","\x1b[1;96mAJMIR","\x1b[1;97mAJMIR","\x1b[1;91mAJMIR","\x1b[1;92mAJMIR","\x1b[1;93mAJMIR","\x1b[1;94mAJMIR","\x1b[1;95mAJMIR","\x1b[1;96mAJMIR"])
...
def m3(idf,pw):
 ...
 global ok
 global agents
 animasi = random.choice(["\x1b[1;91mAJMIR","\x1b[1;92mAJMIR","\x1b[1;93mAJMIR","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING","\x1b[1;97mKING","\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING"])
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [AJMIR-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mAJMIR-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
...
if __name__=='__main__':
  try:os.mkdir('KING-AJMIR')
  except:pass
  try:os.mkdir('QUEEN-JERIN')
  except:pass
#  b2()
#  mainx() 
  mainx()
